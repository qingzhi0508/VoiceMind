...
1. 在 Xcode 左侧项目导航器中，找到 **VoiceRelayiOS** 项目
2. 展开 **VoiceRelayiOS** 文件夹

#### 添加 ViewModels 文件夹
1. 右键点击 **VoiceRelayiOS** 文件夹
2. 选择 **Add Files to "VoiceRelayiOS"...**
3. 导航到 `VoiceRelayiOS/VoiceRelayiOS/ViewModels`
4. 选择整个 **ViewModels** 文件夹
5. 确保勾选：
   - ✅ Copy items if needed
   - ✅ Create groups
   - ✅ VoiceRelayiOS (target)
6. 点击 **Add**

#### 添加 Views 文件夹中的新文件
1. 右键点击 **VoiceRelayiOS** 文件夹下的 **Views** 文件夹（如果没有，先创建）
2. 选择 **Add Files to "VoiceRelayiOS"...**
3. 导航到 `VoiceRelayiOS/VoiceRelayiOS/Views`
4. 选择以下文件：
   - PairingView.swift
   - SettingsView.swift
...
1. 右键点击 **VoiceRelayiOS** 文件夹
2. 选择 **Add Files to "VoiceRelayiOS"...**
3. 选择 `VoiceRelayiOS/VoiceRelayiOS/Info.plist`
4. 确保勾选：
   - ✅ Copy items if needed
   - ✅ VoiceRelayiOS (target)
5. 点击 **Add**
...
3. 确认路径正确：`VoiceRelayiOS/Info.plist`
